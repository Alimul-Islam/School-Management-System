...
namespace SchoolManagementSystem.Setup
{
    public partial class Class : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click1(object sender, EventArgs e)
        {
            ...
            {
                save = objSetup.SetupClass_InsertUpdateDelete(1, 1, txtClass.Text, int.Parse(Session["UserId"].ToString()));
                if (save > 0)
                {
            ...
            {
                save = objSetup.SetupClass_InsertUpdateDelete(2, 1, txtClass.Text, int.Parse(Session["UserId"].ToString()));
                if (save > 0)
                {
        ...
        protected void gvClass_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                int save1 = objSetup.SetupClass_InsertUpdateDelete(3, 1, txtClass.Text, int.Parse(Session["UserId"].ToString()));
                if (save1 > 0)
                {
