...
namespace SchoolManagementSystem.Setup
{
    public partial class Subject: System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                save = objSetup.SetupSubject_InsertUpdateDelete (2,0, txtSubject.Text, int.Parse(Session["UserId"].ToString()));
                if (save > 0)
                {
        ...
        protected void gvSubject_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                int save1 = objSetup.SetupSubject_InsertUpdateDelete(3,0, txtSubject.Text, int.Parse(Session["UserId"].ToString()));
                if (save1 > 0)
                {
